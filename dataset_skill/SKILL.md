...
python scripts/update_dataset.py DATASET_ID --name "Updated Dataset" --json
python scripts/upload.py DATASET_ID /path/to/file.pdf --json
python scripts/upload.py list DATASET_ID --json
python scripts/update_document.py DATASET_ID DOC_ID --name "Updated Document" --json
...
python scripts/search.py "query" --json
